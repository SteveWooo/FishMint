...
const { Button, TextField } = window.MaterialUI
...
class FactoryPanel extends React.Component {
    ...
    async openAppNameEditFrame() {
        this.setState({
            ...
            editingAppDirNameError: true,
            editingAppDirName: this.state.currentAppInfo.appDirName.substring(
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <img style={{
                                ...
                                height: '90px',
                                userSelect: 'none',
                            }} src={this.state.currentAppInfo.icon} title={`${this.state.i18n['capp-setIconTips']}`} />
                        </div>
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                源码目录：{this.state.currentAppInfo.appDirName}
                            </div>
                        </div>
                        ...
                        <div style={{
                            ...
                            }} className={`hvr-wobble-skew`} title={`${this.state.i18n['capp-closeAllThisApp']}`}>
                        ...
                        <button onClick={async () => {
                            await fm.controller.closeApp({
                                appDirName: "apps/github.com.stevewooo/chat"
                            })
                        }}>close chat</button> */}
                    </div>
                )}
