...
## 🏃‍快速开始
这个项目基于 WebBrowser 概念，让您的桌面挂件风格、功能均能基于 Web 技术栈自由搭建。每一个桌面挂件都源于开源，为您带来随心所欲的创作乐趣，让您的桌面焕发个性光彩！

- 下载基座：进入 [下载页面](https://github.com/SteveWooo/Capybara/releases) 解压，双击可执行程序即可启动基座
...
## ♥获取本项目最新挂件库
进入程序目录，将 Capybara 目录删除，然后克隆本项目到原本 Capybara 的位置即可。

## 💻开机启动
因为 ~~懒了~~ 尽量不想动你的注册表，外加担心你写的工程会因为基座版本发生诡异的冲突，所以自动更新、开机启动功能就不集成到内核了

各个系统开机自启方式很多，指向程序包解压出来的可执行程序 Capybara 即可。以下是windows的开机自启步骤：
...
[配置项说明](https://stevewooo.github.io/Capybara/global.html#WindowConfigure)
...
// ==> log res
```
#### [详细接口文档](https://stevewooo.github.io/Capybara)
